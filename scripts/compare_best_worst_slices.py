...
def create_slice_visualization(slice_idx, fig_num=1):
    ...
    im4 = ax4.imshow(two_slice.T - single_slice.T, cmap='RdBu_r', origin='lower', vmin=-0.05, vmax=0.05)
    ...
    im8 = ax8.imshow((diff_two - diff_single).T, cmap='RdBu_r', origin='lower', vmin=-0.05, vmax=0.05)
...
fig1.savefig('../results/current/best_single_channel_slice.png', dpi=150, bbox_inches='tight')
print(f"Saved: ../results/current/best_single_channel_slice.png")

print("\nGenerating visualization for best two-channel slice...")
fig2 = create_slice_visualization(best_two_idx, fig_num=2)
fig2.savefig('../results/current/best_two_channel_slice.png', dpi=150, bbox_inches='tight')
print(f"Saved: ../results/current/best_two_channel_slice.png")
...
fig3.savefig('../results/current/moderate_single_channel_slice.png', dpi=150, bbox_inches='tight')
print(f"Saved: ../results/current/moderate_single_channel_slice.png")

print("\nGenerating visualization for moderate two-channel advantage...")
fig4 = create_slice_visualization(moderate_two_idx, fig_num=4)
fig4.savefig('../results/current/moderate_two_channel_slice.png', dpi=150, bbox_inches='tight')
print(f"Saved: ../results/current/moderate_two_channel_slice.png")
...
plt.tight_layout()
fig5.savefig('../results/current/performance_summary_all_slices.png', dpi=150, bbox_inches='tight')
print(f"Saved: ../results/current/performance_summary_all_slices.png")
...
print("  3. moderate_single_channel_slice.png - Moderate single-channel advantage")
print("  4. moderate_two_channel_slice.png - Moderate two-channel advantage")
...
print(f"  - Slice 11: As requested (single better by {(ierrs_two_all[10]-ierrs_single_all[10])/ierrs_two_all[10]*100:.1f}%)")
