"""
Recreate Figure 8 from the paper using VICTRE phantom:
...
Figure 8 shows ICA distribution reconstruction with VICTRE phantom
- Top row: x-y plane (in-plane) views
- Bottom row: x-z plane (depth) views
- Phantom vs Single-channel L1-DTV vs Two-channel L1-DTV
"""
...
print("Convergence plot shows middle slice (used in Figure 8 top row)")
