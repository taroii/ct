...
istops = [1, 2, 5, 10, 20, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
...
plt.plot(derrs_single, 'r-', label='Single-channel', linewidth=2)
plt.plot(derrs_two, 'b-', label='Two-channel', linewidth=2)
...
plt.plot(ierrs_single, 'r-', label='Single-channel', linewidth=2)
plt.plot(ierrs_two, 'b-', label='Two-channel', linewidth=2)
plt.xlabel('Iteration', fontsize=12)
...
plt.plot(tvs_single, 'r-', label='Single-channel', linewidth=2)
plt.plot(tvs_two, 'b-', label='Two-channel', linewidth=2)
...
# ============================================================================
# RECONSTRUCTION VS GROUND TRUTH COMPARISON (2x2)
# ============================================================================
...
ax_single = axes[0, 0]
ax_single.imshow(xbarim_single.T, cmap='gray', origin='lower', vmin=0, vmax=1.5)
ax_single.set_title('Single-Channel Reconstruction', fontsize=13, fontweight='bold')
ax_single.axis('off')

ax_two = axes[0, 1]
ax_two.imshow(xbarim_two.T, cmap='gray', origin='lower', vmin=0, vmax=1.5)
ax_two.set_title('Two-Channel Reconstruction', fontsize=13, fontweight='bold')
ax_two.axis('off')

# Bottom row: Differences from ground truth
diff_single = xbarim_single - phimage
diff_two = xbarim_two - phimage

ax_diff_single = axes[1, 0]
ax_diff_single.imshow(diff_single.T, cmap='gray', origin='lower', vmin=-0.5, vmax=0.5)
ax_diff_single.set_title(f'Single-Channel − Ground Truth\nRMSE: {ierrs_single[-1]:.4f}', fontsize=13, fontweight='bold')
ax_diff_single.axis('off')

ax_diff_two = axes[1, 1]
ax_diff_two.imshow(diff_two.T, cmap='gray', origin='lower', vmin=-0.5, vmax=0.5)
ax_diff_two.set_title(f'Two-Channel − Ground Truth\nRMSE: {ierrs_two[-1]:.4f}', fontsize=13, fontweight='bold')
ax_diff_two.axis('off')

plt.tight_layout()
plt.savefig('reconstruction_differences.png', dpi=150, bbox_inches='tight')
print("Saved reconstruction differences plot to 'reconstruction_differences.png'")
plt.show()
