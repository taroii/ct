...
plt.tight_layout()
plt.savefig('../results/current/victre_phantom_roi_centered.png', dpi=150, bbox_inches='tight')
print(f"\nSaved visualization: ../results/current/victre_phantom_roi_centered.png")

# Save ROI and lesion info
np.save('../data/generated_roi/old rois/victre_phantom_roi_centered.npy', phantom_roi)
np.save('../data/generated_roi/old rois/victre_lesions_roi_centered.npy', lesions_in_roi)
print(f"\nSaved ROI data:")
print(f"  - ../data/generated_roi/old rois/victre_phantom_roi_centered.npy: {phantom_roi.shape} array")
print(f"  - ../data/generated_roi/old rois/victre_lesions_roi_centered.npy: {lesions_in_roi.shape} lesion coordinates")
